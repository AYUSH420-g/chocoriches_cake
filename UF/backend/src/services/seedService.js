...
import { initialCartItems, initialOrders, memory, products, profileUser } from "../utils/memoryStore.js";
...
export async function seedDatabase() {
  ...
  if ((await CartItem.countDocuments()) === 0) {
    await CartItem.insertMany(initialCartItems);
  }

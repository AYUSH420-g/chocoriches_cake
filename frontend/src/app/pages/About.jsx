...
export default function About() {
  return (
    <div className="bk-page min-h-screen bg-[#f7f7f7] py-12 md:py-20">
      <div className="bk-shell max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <span className="mx-auto mb-4 grid h-16 w-16 place-items-center rounded-full bg-[#fff2e9] text-[#e61951]">
            <CakeSlice size={32} />
          </span>
          <h1 className="text-4xl font-black text-[#1f2221] tracking-tight sm:text-5xl">
            About ChocoRiches
          </h1>
        </div>

        <div className="bg-white rounded-2xl shadow-sm border border-[#ebebeb] p-8 md:p-12 space-y-8 text-[#1f2221] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-black text-[#1f2221] mb-6">Why Choose ChocoRiches?</h2>
          ...
          <section className="text-center space-y-6">
            <p className="text-lg font-medium text-[#6f7573]">
